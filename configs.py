...
class Config(object):
	...
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "Anime_Builder_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002353049842))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "6170962395"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://sajideditz27:8aa5To5ymnvexRBb@cluster0.a2ity.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002353049842")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002367385611")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://i.ibb.co/P9JCb6P/image.jpg")
...
🤖 **ᴍʏ ɴᴀᴍᴇ:** [ꜰɪʟᴇꜱ ꜱᴛᴏʀᴇ ʙᴏᴛ](https://t.me/{Anime_Builder_bot})
